...
local Library do 
        ...
        Library.Notification = function(self, Data)
            local Items = { } do 
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    Image = (Data.Icon and (Data.Icon:sub(1,4)=="http" or Data.Icon:sub(1,13)=="rbxassetid://") and Data.Icon or "rbxassetid://"..(Data.Icon or "")),
                    BackgroundTransparency = 1,
        ...
        Library.Page = function(self, Data)
            ...
            local Items = { } do
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    AnchorPoint = Vector2New(0, 0.5),
                    Image = (Page.Icon and (Page.Icon:sub(1,4)=="http" or Page.Icon:sub(1,13)=="rbxassetid://") and Page.Icon or "rbxassetid://"..(Page.Icon or "")),
                    BackgroundTransparency = 1,
        ...
        Library.Pages.Section = function(self, Data)
            ...
            local Items = { } do
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    Size = UDim2New(0, 21, 0, 20),
                    AnchorPoint = Vector2New(0, 0.5),
                    Image = (Section.Icon and (Section.Icon:sub(1,4)=="http" or Section.Icon:sub(1,13)=="rbxassetid://") and Section.Icon or "rbxassetid://"..(Section.Icon or "")),
                    BackgroundTransparency = 1,
                    Position = UDim2New(0, 15, 0.5, 0),
                    ZIndex = 2,
                    BorderSizePixel = 0,
    ...
    Library.CreateSettingsPage = function(self, Window, KeybindList)
        ...
        local ConfigsSection = Page:Section({Name = "Configs", Side = 2}) do 
            ...
            ConfigsSection:Button({
                Name = "Save As Default (Auto Load)",
                Callback = function()
                    writefile(Library.Folders.Configs .. "/default.json", Library:GetConfig())
                    Library:RefreshConfigsList(ConfigsDropdown)
                end
            })
            ...
            ConfigsSection:Toggle({
                ...
                Flag = "AutoLoadConfig",
                Default = isfile(Library.Folders.Configs .. "/autoload.flag"),
                Callback = function(state)
                    if state then
                        writefile(Library.Folders.Configs .. "/autoload.flag", "1")
                    else
                        if isfile(Library.Folders.Configs .. "/autoload.flag") then
                            delfile(Library.Folders.Configs .. "/autoload.flag")
                        end
                    end
                end
            })
